...
print("── Leapfrog Labs · Lab 09 — Ship something tiny, end to end ──")
print("First run downloads a small model. Watch: it grounds on a policy, returns a")
print("structured route, and stays inside its allowlist.\n")
...
result = triage("The billing page has been down for an hour!", decide_stub)
print("Decision (grounded, structured, and contained):")
